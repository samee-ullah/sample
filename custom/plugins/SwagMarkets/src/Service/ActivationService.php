...
class ActivationService
{
    ...
    public function __construct(
        ...
        $this->client = new Client(
            [
                'base_uri' => $_ENV['APP_ENV'] == 'dev' ? $this->params->get('swagMarkets.host.staging') : $this->params->get('swagMarkets.host.production'),
                'headers' => [
            ...
            [
                [
                    ...
                    'configurationValue' => [
                        ...
                        'shop_id' => $_ENV['APP_ENV'] == 'dev' ? 'shopware6_brickfox_staging' : '',
                        'swagMarkets_systems' => [
                            'erp_systems' => [
